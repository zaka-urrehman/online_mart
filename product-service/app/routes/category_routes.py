...
async def add_category(category: Annotated[Category, Depends(add_category_in_db)]):
    """
...
async def update_category(category: Annotated[Category, Depends(update_category_in_db)]):
    """
...
async def delete_category(result: Annotated[dict, Depends(delete_category_from_db)]):
    """
